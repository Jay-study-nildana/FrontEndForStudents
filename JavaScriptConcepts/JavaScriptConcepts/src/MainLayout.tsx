...
export default function MainLayout(): JSX.Element {
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden bg-gradient-to-br from-sky-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 text-slate-900 dark:text-slate-100">
