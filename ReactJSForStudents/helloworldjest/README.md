# React JS Hello World Project with jest
...
1. npm run test - runs the tests and creates first snapshot.
1. npm run test:update - updates the snapshot to match new ui.
...
1. 1. https://medium.com/projectwt/create-react-app-hello-world-2022-edition-f36275a0e7c4
1. https://reactgo.com/react-testing-tutorial-jest/
