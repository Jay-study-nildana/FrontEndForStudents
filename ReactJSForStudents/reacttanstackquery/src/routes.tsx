...
const QueryPageOne = lazy(() => import("./tanstackquerydemos/QueryPageOne"));
const QueryAdvancedDemo = lazy(() => import("./tanstackquerydemos/QueryAdvancedDemo"));
...
export const routesConfig: AppRoute[] = [
  ...
  },
  {
    ...
    name: "TanStack Query Demo",
    element: <QueryPageOne />,
  },
  {
    path: "/tanstack-query-advanced-demo",
    name: "TanStack Query Advanced Demo",
    element: <QueryAdvancedDemo />,
  },
  {
    path: "*",
    element: <NotFound />,
